...
export const greenArrowDown = <div className="rotate-90">{greenArrowUp}</div>;
export const redArrowDown = <div className="rotate-90">{redArrowUp}</div>;
